 ...
 */
export const getUser = userId => Accounts.users.findOne({userId: userId || Router.current().params.userId}) ||
 ...
 * @returns {*}
 */
export const isUserLogs = () => Router.current().url.match(/setting\/users\/(.+)?/) ?
    getUser() : false;
